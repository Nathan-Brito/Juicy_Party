...
define config.name = _("Juicy Party")
...
define config.main_menu_music = "audio/BGM/Title Scene.ogg"
...
define config.save_directory = "JuicyParty-1745082487"
